...
main.o: main.s gpio.s app.s draw.s drawPacman.s movementPacman.s bolitas.s fantasmas.s
	$(ARMGNU)-as $(AOPS) main.s gpio.s app.s draw.s drawPacman.s movementPacman.s bolitas.s fantasmas.s -o main.o
